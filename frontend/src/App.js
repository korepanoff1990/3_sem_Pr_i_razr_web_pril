...
function App() {
  ...
  return (
    <div className="App">
      ...
      <img height="400px" width="100%" src="https://sun9-31.userapi.com/impg/nZIWArJVxc2y42WNGOGD8ibl9wy6yi6jrkUb6A/ZfjrewqeN9A.jpg?size=1749x415&quality=96&sign=421a8352b2d867c42cd8a1005dd65ac8&type=album"></img>
      {pages[page]}
      {modalBoxes[modalBox]}
      <Footer />
